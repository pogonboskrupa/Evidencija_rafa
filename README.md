...
- **Tamna tema** (Postavke → Izgled) — prekidač "Prati sistem / Svijetla / Tamna". Podrazumijevano prati postavku uređaja/preglednika; ručni izbor se pamti po uređaju (ne po korisničkom računu) i vrijedi i na ekranu za prijavu, bez bljeska pogrešne teme pri učitavanju.
