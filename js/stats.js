...
window.Stats = (function () {
  const { DAY_TYPES, getVacationSettings } = window.Storage;

  function recordsForYear(user, year) {
    const prefix = `${year}-`;
    const out = {};
  ...
  function computeYearStats(user, year) {
  ...
  return { recordsForYear, computeYearStats };
})();
